...
public class GUIPago extends javax.swing.JFrame {
    ...
    public GUIPago(List<Item> cart) {
        ...
        //setMinimumSize(new Dimension(800, 600)); // Establecer un tamaño mínimo adecuado
    ...
    private void btnPagarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPagarActionPerformed
        ...
        String phone = txtNumeroTel.getText();
        ...
        try {
            ...
            if (paymentVerified) {
                ...
                Messages.sendPaymentConfirmationMessage(name, email, phone);
